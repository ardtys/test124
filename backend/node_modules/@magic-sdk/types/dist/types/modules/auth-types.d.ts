...
export declare enum LoginWithSmsOTPEventEmit {
    VerifySmsOtp = "verify-sms-otp",
    Cancel = "cancel",
    Retry = "retry"
}
export declare enum LoginWithSmsOTPEventOnReceived {
...
export declare enum EnableMFAEventOnReceived {
    MFASecretGenerated = "mfa-secret-generated",
    InvalidMFAOtp = "invalid-mfa-otp",
    MFARecoveryCodes = "mfa-recovery-codes"
}
export declare enum EnableMFAEventEmit {
    VerifyMFACode = "verify-mfa-code",
    Cancel = "cancel-mfa-setup"
}
export declare enum DisableMFAEventOnReceived {
    MFACodeRequested = "mfa-code-requested",
    InvalidMFAOtp = "invalid-mfa-otp",
    InvalidRecoveryCode = "invalid-recovery-code"
}
export declare enum DisableMFAEventEmit {
    VerifyMFACode = "verify-mfa-code",
    LostDevice = "lost-device",
...
export type EnableMFAEventHandlers = {
    [EnableMFAEventOnReceived.MFASecretGenerated]: ({ QRCode, key }: {
        QRCode: string;
        key: string;
    }) => void;
    [EnableMFAEventOnReceived.InvalidMFAOtp]: ({ errorCode }: {
        errorCode: string;
    }) => void;
    [EnableMFAEventOnReceived.MFARecoveryCodes]: ({ recoveryCode }: {
        recoveryCode: string;
    }) => void;
...
export type DisableMFAEventHandlers = {
    ...
    [DisableMFAEventOnReceived.InvalidMFAOtp]: ({ errorCode }: {
        errorCode: string;
    }) => void;
